...
function NotifTab({user,showT}){
  ...
  const supported="Notification" in window&&"serviceWorker" in navigator&&"PushManager" in navigator;
  ...
  return <div>
    ...
    {!supported&&<div style={{background:"#fef3c7",borderRadius:10,padding:"12px 14px",fontSize:13,color:"#92400e",border:"1px solid #fde68a"}}>
      Push notification tidak didukung browser ini. Pastikan app sudah di-install ke Home Screen dan dibuka dari sana (bukan dari browser).
    </div>}
    ...
    <div style={{minHeight:"100vh",width:"100%",background:"linear-gradient(160deg,"+NAVY+" 0%,#142238 50%,#0D1F35 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:isMobile?"flex-start":"center",padding:isMobile?"0":"24px",overflowY:"auto"}}>
      ...
      {isMobile&&<>
        ...
        <div style={{width:"100%",background:"white",flex:1,padding:"28px 24px 36px",display:"flex",flexDirection:"column"}}>
          ...
          <button onClick={()=>setShowForgot(true)} style={{width:"100%",padding:"11px",borderRadius:11,border:"1.5px solid #e2e8f0",background:"white",color:"#64748b",cursor:"pointer",fontSize:13,fontWeight:600,marginBottom:8}}>🔑 Lupa Password?</button>
          {bioSupported()&&<>
      ...
      {!isMobile&&<div style={{width:"100%",maxWidth:960,display:"flex",gap:0,borderRadius:20,overflow:"hidden",boxShadow:"0 32px 80px rgba(0,0,0,0.45)"}}>
        ...
        <div style={{width:360,background:"white",padding:"40px 36px",display:"flex",flexDirection:"column",justifyContent:"center"}}>
          ...
          <button onClick={()=>setShowForgot(true)} className="btn-primary" style={{width:"100%",padding:"11px",borderRadius:11,border:"1.5px solid #e2e8f0",background:"white",color:"#64748b",cursor:"pointer",fontSize:13,fontWeight:600,marginBottom:8}}>🔑 Lupa Password?</button>
          {bioSupported()&&<>
