...
const ROLE_LABEL={
  ...
  kasubbag:"Kasubbag Protokol",kasubbag_komdokpim:"Kasubbag Komdokpim",
  ajudan:"Ajudan",
...
const ROLES_WITH_REPORT=["staf","staf_input","kasubbag","kasubbag_komdokpim","kabag","timkom"];
const STAF_ROLES=["staf","staf_input","timkom"];
const KASUBBAG_ROLES=["kasubbag","kasubbag_komdokpim"];
...
export default function App(){
  ...
  React.useEffect(()=>{
    if(!["kasubbag","kasubbag_komdokpim","timkom"].includes(role))return;
    const now=new Date();
  ...
  const getVisible=()=>{
    ...
    else if(role==="kasubbag"||role==="kasubbag_komdokpim")base=tab==="semua"?events:events.filter(e=>e.alur==="menunggu_kasubbag"||(e.alurHapus&&e.alur==="disetujui"));
  ...
  const pendingList=events.filter(e=>{
    if(role==="kasubbag"||role==="kasubbag_komdokpim")return e.alur==="menunggu_kasubbag"||(e.alurHapus==="menunggu_kasubbag");if(role==="kabag")return e.alur==="menunggu_kabag"||(e.alurHapus==="menunggu_kabag");
  ...
  const TH={walikota:{g:"linear-gradient(135deg,"+NAVY+",#1B4080)",a:GOLD},wakilwalikota:{g:"linear-gradient(135deg,#053f2a,#065f46)",a:"#6ee7b7"},ajudan:{g:"linear-gradient(135deg,#1e293b,#334155)",a:"#94a3b8"},timkom:{g:"linear-gradient(135deg,#3730a3,#4f46e5)",a:"#a5b4fc"},staf:{g:"linear-gradient(135deg,"+NAVY+",#1B4080)",a:GOLD},staf_input:{g:"linear-gradient(135deg,#1e3a5f,#2563eb)",a:"#93c5fd"},kasubbag:{g:"linear-gradient(135deg,#78350f,#d97706)",a:"#fde68a"},kasubbag_komdokpim:{g:"linear-gradient(135deg,#1e3a5f,#0284c7)",a:"#7dd3fc"},kabag:{g:"linear-gradient(135deg,#064e3b,#10b981)",a:"#6ee7b7"}};
...
function PimpinanView({events, role, user, onDisposisi, onCatatanSave, setDelegTarget, upd, showT, isMobile}){
  ...
  const myEvs=(
    ...
    :role==="kasubbag"||role==="kasubbag_komdokpim"
    ...
    <div style={{flex:1,overflowY:"auto",background:"#F4F7FF"}}>
      ...
      <div style={{background:"linear-gradient(135deg,"+NAVY+" 0%,#1B3360 100%)",padding:isMobile?"20px 18px 24px":"28px 36px 32px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{color:GOLD,fontSize:12,fontWeight:600}}>
          {fmt(todayStr())} &nbsp;·&nbsp;{" "}
          {(role==="kasubbag"||role==="kasubbag_komdokpim"||role==="kabag")
      ...
      <div style={{padding:isMobile?"14px":"20px 28px"}}>
        ...
        {(role==="kasubbag"||role==="kasubbag_komdokpim"||role==="kabag")&&pendingApproval.length>0&&(
...
// ==================== FORM ====================
  ...
  return <div style={{minHeight:"100vh",width:"100%",background:NAVY,display:"flex"}}>
    ...
    {(role==="kasubbag"||role==="kasubbag_komdokpim"||role==="timkom")&&notifPenugasan.length>0&&tab!=="form"&&
