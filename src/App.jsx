  ...
  const printPDF=()=>{
    ...
    const rows=Object.keys(byTgl).sort().flatMap(tgl=>{
      ...
      return evs.map((ev,iInGroup)=>{
        nomor++;
        const tglCell="<td style='background:#EBF0FA;font-weight:700;color:#0B2545;vertical-align:top;text-align:center;border-right:2px solid #CBD5E1;white-space:nowrap'><strong>"+getHari(tgl)+"</strong><br><span style='font-size:9pt;font-weight:400'>"+fmtShort(tgl)+"</span></td>";
        return (iInGroup===0?"<tr class='ds'>":"<tr>")+"<td class='c'>"+nomor+"</td>"+tglCell+"<td class='c'><strong>"+ev.jam+" WITA</strong></td><td><strong style='font-size:11pt'>"+ev.namaAcara+"</strong><br><span style='font-size:9.5pt;color:#374151'>"+ev.penyelenggara+"</span></td><td class='c "+(ev.jenisKegiatan==="Sambutan"?"u":ev.jenisKegiatan==="Pengarahan"?"b":"g")+"'>"+ev.jenisKegiatan+"</td><td>"+(ev.lokasi||"<em style='color:#cbd5e1'>-</em>")+"</td><td style='font-size:9pt'>"+( ev.kontak||"<em style='color:#cbd5e1'>-</em>" )+"</td><td class='c' style='font-size:9pt'>"+ev.pakaian+"</td><td style='font-size:9pt'>"+((function(e){var l=[];var wk=(e.untukPimpinan||[]).includes("walikota");var wwk=(e.untukPimpinan||[]).includes("wakilwalikota")||e.delegasiKeWWK;if(wk&&!e.delegasiKeWWK){if(e.statusWK==="hadir")l.push("Wali Kota");else if(e.statusWK==="diwakilkan"&&e.perwakilanWK)l.push(e.perwakilanWK);else if(e.statusWK==="diwakilkan")l.push("Perwakilan WK");}if(wwk){if(e.statusWWK==="hadir")l.push("Wakil Wali Kota");else if(e.statusWWK==="diwakilkan"&&e.perwakilanWWK)l.push(e.perwakilanWWK);else if(e.statusWWK==="diwakilkan")l.push("Perwakilan WWK");}return l.join(", ");})(ev))+"</td></tr>";
      });
    }).join("");
    w.document.write("<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Rekap Kegiatan</title><style>@page{size:A4 landscape;margin:1.2cm 1.5cm}*{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact}body{font-family:Arial,sans-serif;font-size:10.5pt;color:#1a1a1a}.kop{display:flex;align-items:center;gap:14px;border-bottom:3px solid #0B2545;padding-bottom:10px;margin-bottom:8px}.kop img{width:52px;height:52px;object-fit:contain}.kop h1{font-size:12pt;font-weight:900;color:#0B2545;margin:0 0 1px}.kop h2{font-size:9pt;font-weight:700;color:#0B2545;margin:0 0 2px}.kop p{font-size:7.5pt;color:#475569;margin:0}.jdl{text-align:center;margin:8px 0}.jdl h3{font-size:12pt;font-weight:900;color:#0B2545;margin:0;text-transform:uppercase;letter-spacing:1px}.jdl p{font-size:9pt;color:#475569;margin:3px 0 0}table{width:100%;border-collapse:collapse;font-size:10.5pt}thead th{background:#0B2545;color:#FFFFFF;padding:9px 8px;text-align:left;font-size:9.5pt;font-weight:700;-webkit-print-color-adjust:exact;print-color-adjust:exact}thead th.c{text-align:center}tbody td{padding:10px 8px;border:1px solid #dde4ef;vertical-align:top;line-height:1.6}tbody tr:nth-child(even) td{background:#f4f7fc}.c{text-align:center}.ds td{border-top:2.5px solid #0B2545!important}.cat{min-width:90px}.u{color:#7c3aed;font-weight:700}.b{color:#2563eb;font-weight:700}.g{color:#065f46;font-weight:700}.ttd{margin-top:22px;display:flex;justify-content:space-between;align-items:flex-end}.ttd-info{font-size:7.5pt;color:#64748b;line-height:1.8}.ttd-info b{color:#1a1a1a;font-size:8pt}.ttd-box{text-align:center;min-width:240px}.ttd-box .loc-date{font-size:8pt;color:#334155;margin:0 0 4px}.ttd-box .jab{font-size:8.5pt;font-weight:700;color:#0B2545;margin:0 0 56px;line-height:1.4}.ttd-box p{margin:0;border:none;padding:0}.ttd-box .nm{font-size:9pt;font-weight:900;color:#0B2545;margin:0 0 2px;letter-spacing:-0.2px;border:none}.ttd-box .nip{font-size:7.5pt;color:#64748b;display:flex;align-items:center;justify-content:center;gap:4px}.ttd-box .nip-line{display:inline-block;border-bottom:1px solid #94a3b8;width:160px;height:12px}.foot{margin-top:8px;font-size:7pt;color:#94a3b8;text-align:center;border-top:1px solid #e2e8f0;padding-top:5px}</style></head><body><div class='kop'><img src='/logo_tarakan.png' onerror=\"this.style.display='none'\"/><div><h1>PEMERINTAH KOTA TARAKAN</h1><h2>BAGIAN PROTOKOL DAN KOMUNIKASI PIMPINAN</h2><p>Sekretariat Daerah Kota Tarakan</p></div></div><div class='jdl'><h3>Rekap Agenda Kegiatan Pimpinan</h3><p>Periode: "+rangeLabel()+" &bull; Dicetak: "+printDateTime+" &bull; Total: <strong>"+filtered.length+" kegiatan</strong></p></div><table><thead><tr><th class='c' style='width:22px'>No</th><th style='width:70px'>Hari/Tgl</th><th class='c' style='width:48px'>Pukul<br>(WITA)</th><th>Nama Acara / Penyelenggara</th><th class='c' style='width:70px'>Jenis</th><th style='width:120px'>Tempat/Lokasi</th><th style='width:85px'>Contact Person</th><th class='c' style='width:72px'>Pakaian</th><th style='width:100px'>Dihadiri Oleh</th><th style='width:85px'>Catatan<br>Kepala Daerah</th></tr></thead><tbody>"+rows+"</tbody></table><div class='ttd'><div class='ttd-info'><b>Dicetak oleh:</b> "+cetakOleh+"<br><b>Sistem:</b> Bagian Protokol dan Komunikasi Pimpinan Setda Kota Tarakan</div><div class='ttd-box'><p class='loc-date'>Tarakan, "+printDate+"</p><p class='jab'>Kepala Bagian Protokol dan Komunikasi Pimpinan</p><p class='nm'>Anugrah Yega Pranatha, M.Si.</p><p class='nip'>NIP. 198811032007011003</p></div></div><p class='foot'>Sistem Terpadu Jadwal dan Agenda Kegiatan Pimpinan #TarakanHibot</p></body></html>");
  ...
  const saveEvaluasi=(evId, entry)=>{
    ...
    for(const un of personilArr){
      ...
      if(u){
        ...
        if(u.noWA) sendWA({to:u.noWA,namaAcara:ev?.namaAcara,tanggal:ev?.tanggal,jam:ev?.jam,penyelenggara:ev?.penyelenggara,lokasi:ev?.lokasi,event:"penugasan",namaPersonil:u.nama,catatanPenugasan:catatanPenugasan||""});
      }
    }
