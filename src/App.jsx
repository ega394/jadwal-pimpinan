  ...
  const analyze=async f=>{
    ...
    try{
      ...
      const bodyContent=isPdf
        ?[{type:"document",source:{type:"base64",media_type:"application/pdf",data:b64}},{type:"text",text:'Balas HANYA JSON ini tanpa penjelasan. Tanggal: YYYY-MM-DD, Jam: HH:MM: {"namaAcara":"","tanggal":"","jam":"","penyelenggara":"","kontak":"","pakaian":"","jenisKegiatan":"","catatan":"","buktiUndangan":"","lokasi":"","untukPimpinan":["walikota"]}'}]
        :[{type:"image",source:{type:"base64",media_type:f.type,data:b64}},{type:"text",text:'Balas HANYA JSON ini tanpa penjelasan. Tanggal: YYYY-MM-DD, Jam: HH:MM: {"namaAcara":"","tanggal":"","jam":"","penyelenggara":"","kontak":"","pakaian":"","jenisKegiatan":"","catatan":"","buktiUndangan":"","lokasi":"","untukPimpinan":["walikota"]}'}];
...
function ReportingModal({events,onClose,kabagNama}){
  ...
  const printPDF=()=>{
    ...
    const printDateTime=printDate+" pukul "+printTime+" WIB";
...
export default function App(){
  ...
  if(!user){
    ...
    return(
    <div style={{minHeight:"100vh",width:"100%",background:"linear-gradient(160deg,"+NAVY+" 0%,#142238 50%,#0D1F35 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:isMobile?"flex-start":"center",padding:isMobile?"0":"24px",overflowY:"auto"}}>
      <style>{CSS}</style>
